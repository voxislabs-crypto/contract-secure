...
const contractBody = `# Car Loan Agreement
## Parties
- Lender: [Your Name]
...
## Default
If the Borrower fails to make a payment within 15 days of the due date, the
entire remaining balance shall become immediately due and payable.
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-xl shadow overflow-hidden">
        ...
        <div className="p-6">
          <pre className="whitespace-pre-wrap font-sans text-sm text-gray-800">{contract.content}</pre>
        </div>
